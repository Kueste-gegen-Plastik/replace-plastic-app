...
<script>
import KgpHeader from '@/components/KgpHeader';
...
@font-face {
    font-family: 'Lato';
    src: url('./assets/fonts/LatoLatin/LatoLatin-Medium.woff2') format('woff2'), /* Modern Browsers */
    url('./assets/fonts/LatoLatin/LatoLatin-Medium.woff') format('woff');
    font-style: normal;
    font-weight: normal;
...
@font-face {
    font-family: 'Lato';
    src: url('./assets/fonts/LatoLatin/LatoLatin-MediumItalic.woff2') format('woff2'), /* Modern Browsers */
    url('./assets/fonts/LatoLatin/LatoLatin-MediumItalic.woff') format('woff');
    font-style: italic;
    font-weight: normal;
    text-rendering: optimizeLegibility;
}
...
@font-face {
    font-family: 'Lato';
    src: url('./assets/fonts/LatoLatin/LatoLatin-Bold.woff2') format('woff2'), /* Modern Browsers */
    url('./assets/fonts/LatoLatin/LatoLatin-Bold.woff') format('woff');
    font-style: normal;
    font-weight: bold;
    text-rendering: optimizeLegibility;
}
...
@font-face {
    font-family: 'Lato';
    src: url('./assets/fonts/LatoLatin/LatoLatin-BoldItalic.woff2') format('woff2'), /* Modern Browsers */
    url('./assets/fonts/LatoLatin/LatoLatin-BoldItalic.woff') format('woff');
    font-style: italic;
    font-weight: bold;
    text-rendering: optimizeLegibility;
}
