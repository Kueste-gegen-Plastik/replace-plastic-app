<template>
    <div class="step">
        ...
        <div class="step__inner">
            <div class="content">
                <p class="n">Geltungsbereich<br>
                <br>
                Diese Datenschutzerklärung klärt Nutzer über die Art, den Umfang und Zwecke der Erhebung und Verwendung personenbezogener Daten durch den verantwortlichen Anbieter Küste gegen Plastik e.V., post@kueste-gegen-plastik.de, Tel: 04881 9370323, auf dieser Website (im folgenden “Angebot”) auf.<br>
                <br>
                ...
                <br>
                Die Nachfolgekommentare können durch Nutzer abonniert werden. Die Nutzer erhalten eine Bestätigungsemail, um zu überprüfen, ob sie der Inhaber der eingegebenen Emailadresse sind. Nutzer können laufende Kommentarabonnements jederzeit abbestellen. Die Bestätigungsemail wird Hinweise dazu enthalten.<br>
                <br>
                ...
                <br>
                Wenn ein Nutzer Facebookmitglied ist und nicht möchte, dass Facebook über dieses Angebot Daten über ihn sammelt und mit seinen bei Facebook gespeicherten Mitgliedsdaten verknüpft, muss er sich vor dem Besuch des Internetauftritts bei Facebook ausloggen. Weitere Einstellungen und Widersprüche zur Nutzung von Daten für Werbezwecke, sind innerhalb der Facebook-Profileinstellungen möglich: <a href="https://www.facebook.com/settings?tab=ads." target="_blank">https://www.facebook.com/settings?tab=ads.</a><br>
                <br>
                ...
                Weitere Informationen hierzu finden sich in der Datenschutzerklärung von Twitter unter <a href="http://twitter.com/privacy." target="_blank">http://twitter.com/privacy.</a><br>
                <br>
                ...
                Datenschutz-Muster von Rechtsanwalt Thomas Schwenke - I LAW it</p>
            </div>
        </div>
    </div>
</template>
