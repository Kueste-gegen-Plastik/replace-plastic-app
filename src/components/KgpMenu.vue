<template>
  <div class="menu">
    <button @click="open = !open"
      class="menu__button"
      v-bind:class="{ 'menu__button--open' : open }"
      type="button"
      aria-controls="menu__items"
      v-bind:aria-label="'Menü ' + open ? 'schließen' : 'öffnen'"
      v-bind:aria-expanded="open">
      <span class="menu__button-box">
        <span class="menu__button-inner"></span>
      </span>
    </button>
    <div v-bind:class="{ 'menu__items--open' : open }" id="menu__items" class="menu__items">
        <ul class="menu__nav">
